            ...
            <div class="p_pro_m">
                <div class="p_pro_list">
                    <ul>
                        ...
                        <li>
                            <a data-type="mip" data-title="{{$dianmianlist->title}}"title="{{$dianmianlist->title}}"  href="/article/{{$dianmianlist->id}}.shtml">
                                <div class="p_pro_img"><mip-img layout="responsive" width="160" height="160" src="{{$dianmianlist->litpic}}" alt="{{$dianmianlist->title}}" class="mip-element mip-layout-responsive mip-layout-size-defined mip-img-loaded" mip-firstscreen-element=""><mip-i-space style="display: block; padding-top: 80%;">space</mip-i-space><img class="mip-fill-content mip-replaced-content" src="{{$dianmianlist->litpic}}" alt="{{$dianmianlist->title}}"></mip-img></div>
                                <div class="p_pro_text">{{str_limit($dianmianlist->title,20,'')}}</div>
                            </a>
                        </li>
                        @endforeach
                    </ul>
