...
@section('main')
    <header>
        ...
        <div class="i_abo_box">
            ...
            <div class="i_abo_m">   国潮新中式茶饮—满气茶奶茶，由南京同仁堂授权，隶属于上海颁程企业管理有限公司，致力于结合中国深厚的文化底蕴，创造茶饮行业新价值，不盲从，敢不同。随处可见的京剧、中国红、中式装修风格、开发的中式周边产品都有浓厚的中国文化特色，并且满气茶相信……<a href="/xinwen/2019121912.html">更多</a></div>
        </div>
    </header>
