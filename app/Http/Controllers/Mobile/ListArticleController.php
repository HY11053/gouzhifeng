...
class ListArticleController extends Controller
{
    public function About(){
        ...
        return view('mobile.about',compact('thisTypeinfos','productions','latestnews'));
    }
    ...
    public function Productions(Request $request,$path=''){
        ...
        $productions=Arctype::where('reid',2)->get(['typename','real_path']);
        $latestnews=Archive::whereIn('typeid',[7,8])->take(10)->latest()->get(['id','typeid','title','created_at']);
        return view('mobile.productions',compact('thisTypeinfos','productions','latestnews','productionlists'));
    }
    ...
    public function Mendian(){
        ...
        return view('mobile.dianmian',compact('thisTypeinfos','productions','latestnews','dianmianlists'));
    }
    ...
    public function News(Request $request,$path=''){
        ...
        return view('mobile.news',compact('thisTypeinfos','latestnews','newstypes','newslists'));
    }
}
